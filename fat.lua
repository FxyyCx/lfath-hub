...
-- GUI
local ScreenGui = Instance.new("ScreenGui"); ScreenGui.Name = "lfathhScript"; ScreenGui.ResetOnSpawn = false; ScreenGui.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
...
Title.BackgroundTransparency = 1; Title.Text = "TIKTOK @s7vxtyr"; Title.TextColor3 = Color3.fromRGB(255, 100, 100)
...
print("Lfathh Script Loaded - AutoRejoin & Enhanced Anti-AFK Added!")
